...
trino-jdbc-475.jar
```
Links to [Maven artifacts](https://github.com/mrdominguez/generic-jdbc-client/blob/master/README.md#dependencies) below.
```
$ mvn clean package
...
[INFO] Finished at: 2025-05-28T18:19:36-04:00
[INFO] ------------------------------------------------------------------------
$
$ java -cp target/JdbcClient-5.0-SNAPSHOT-jar-with-dependencies.jar com.github.mrdominguez.JdbcClient
Missing required option: s
usage: JdbcClient [--b64keytab <arg>] [--b64krbConf <arg>] [--b64sslTrustStore <arg>] [-c <arg>] [-d <arg>] [-f <arg>] [-h <arg>]
...
### Trino (Hive catalog)
```
$ java -cp JdbcClient.jar com.github.mrdominguez.JdbcClient \
-s trino -h $(hostname -f) -k \
...
\__ Executing query...
trino _col0,  475 _col1,  hive _col2,  default _col3
---
```
...
$ java -cp JdbcClient.jar com.github.mrdominguez.JdbcClient \
-s trino -propFile trino.properties
...
Connection established
\__ Executing query...
hadoop _c0,  3.1.3-amzn-8 rUnknown _c1,  default _c2
---
```
### Generic: MariaDB
...
```
$ java -cp JdbcClient.jar com.github.mrdominguez.JdbcClient \
-s generic --jdbcUrl jdbc:mariadb://$(hostname -f):3306 \
